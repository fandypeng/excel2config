...
type Dao interface {
	...
	AddUser(c context.Context, email, passwd, name string, loginType int, openId string) (userInfo *model.UserInfo, err error)
	SaveUser(c context.Context, userInfo *model.UserInfo) (err error)
