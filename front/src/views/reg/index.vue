<template>
  <div class="login-container">
    <el-form ref="regForm" :model="regForm" :rules="regRules" class="reg-form" auto-complete="on" label-position="left">
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleReg">Login</el-button>

      <div class="tips">
        <div class="tips">
        <span style="margin-right:20px;">
          已有帐号？<el-link href="#/login" type="primary"> 点击登录 </el-link>
          </span>
      </div>
      </div>
